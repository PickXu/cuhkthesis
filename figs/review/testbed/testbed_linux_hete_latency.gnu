...
set xtics 0,2000,7951 offset 0,0.4
set logscale y
set key top left box lw 2 reverse Left font ',55' width '2' samplen 4 spacing 1
...
''	using ($1):($3) every 100 title 'VEDP' w lp ls 2, \
''      using ($1):($4) every 100 title 'VCEDP' w lp ls 5
