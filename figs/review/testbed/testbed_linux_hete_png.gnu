...
set output 'testbed_linux_hete.png'
set size 0.9,0.9
#set size ratio 0.6
...
set key top left maxcols 4 maxrows 1 Left nobox reverse samplen 3 font ', 40' width '0'
#set key top right reverse Left font ',50' width '2' samplen 3 spacing 1
...
# draw some plots
#
plot 'testbed_linux_hete.tsv' \
	using ($2) fill pattern 4 lt -1 lc rgb 'black' title 'CEDP', \
