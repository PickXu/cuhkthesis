...
set output 'testbed_linux_size.eps'
set size 1.8,1.1
#set size ratio 0.6
...
# draw some plots
#
plot 'testbed_linux_size.tsv' \
	using ($1) fill pattern 3 lt -1 lc rgb 'black' title 'VEDP'
