...
set terminal postscript enhanced portrait 'Times-Roman' 70 size 7,6 dl 3.5
set output "testbed_linuxtar_hete_latency.eps"
set size 1.8,1.1
...
set xtics 0,50,322 offset 0,0.4
set logscale y
set key bottom right box lw 2 reverse Left font ',70' width '1' samplen 3 spacing 1
...
plot "testbed_linuxtar_hete_latency.tsv" \
	using ($4):($1) every 100 title 'BASLINE' w lp ls 1, \
''	using ($4):($2) every 100 title 'VEDP' w lp ls 2, \
''      using ($4):($3) every 100 title 'VCEDP' w lp ls 5
