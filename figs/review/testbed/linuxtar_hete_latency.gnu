...
set output "linuxtar_hete_latency.eps"
set size 1.8,1.1
...
set ylabel 'Latency(sec)' offset 2
...
#set logscale y
set key bottom right reverse Left font ',60' width '1' samplen 2 spacing 1
