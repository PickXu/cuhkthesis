...
set output "fsl_read_balance.eps"
set size 1.8,1.1
...
set key top left horizontal maxcols 4 maxrows 1 Left nobox reverse samplen 3 font ', 65' width '0'
#set key top left reverse Left font ',65' samplen 3 spacing 1
