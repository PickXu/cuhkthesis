...
set terminal postscript enhanced portrait 'Times-Roman' 73 size 10,8 dl 3.5
set output 'linuxtar_hete.eps'
set size 1.8,1.1
#set size ratio 0.6
...
set ylabel "Improvement (%)" offset 2, 0

unset key
#set key top right horizontal maxcols 4 maxrows 1 Left nobox reverse samplen 3 font ', 30' width '0'
set key top right box lw 2 reverse Left font ',70' width '1' samplen 3 spacing 1
