...
set output 'linux_hete_histo.eps'
set size 1.8,1.1
#set size ratio 0.6
...
set xtics ('-1' 0, '-0.9' 1, '-0.8' 2, '-0.7' 3, '-0.6' 4, '-0.5' 5, '-0.4' 6, '-0.1' 7, '0' 8, '0.1' 9, '0.2' 10, '0.3' 11, '0.4' 12, '0.5' 13, '0.6' 14, '0.7' 15, '0.8' 16, '0.9' 17, '1' 18) offset 0,0.4
...
# draw some plots
#
plot 'linux_hete_histo.tsv' \
	using ($2*100) fill pattern 4 lt -1 lc rgb 'black' title 'EDP', \
'' 	using ($1*100) fill pattern 3 lt -1 lc rgb 'black' title 'CEDP'
