...
unset key
set key top right horizontal maxcols 4 maxrows 1 Left nobox reverse samplen 3 font ', 40' width '0'
...
# draw some plots
#
plot 'testbed_hete.tsv' \
	using ($1) fill pattern 4 lt -1 lc rgb 'black' title 'CEDP', \
