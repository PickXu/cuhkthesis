...
plot "linuxtar_histo_BASELINE.tsv" using ($1*100):($2*100) title 'Baseline' w lp ls 1, \
     "linuxtar_histo_EDP.tsv" using ($1*100):($2*100) title 'EDP' w lp ls 2
