...
set output "linux_1_120_cdf.eps"
set size 1.8,1.1
...
plot "linux_1_120_BASELINE.tsv" using ($1):($2*100) title 'Baseline' w lp ls 1, \
    "linux_1_120_EDP.tsv" using ($1):($2*100) title 'EDP' w lp ls 2, \
    "linux_1_120_CEDP.tsv" using ($1):($2*100) title 'CEDP' w lp ls 3
