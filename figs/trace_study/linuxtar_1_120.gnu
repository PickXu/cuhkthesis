...
set output "linuxtar_1_120_cdf.eps"
set size 1.8,1.1
...
set key top left reverse Left font ',90' samplen 3 spacing 1
...
set style line 3 lt 3 lw 30 pt 11 ps 0 lc rgb "green"
...
plot "linuxtar_1_120_BASELINE.tsv" using ($1):($2*100) title 'Baseline' w lp ls 1, \
    "linuxtar_1_120_EDP.tsv" using ($1):($2*100) title 'EDP' w lp ls 2, \
    "linuxtar_1_120_CEDP.tsv" using ($1):($2*100) title 'CEDP' w lp ls 3
