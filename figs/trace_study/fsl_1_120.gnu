...
plot "fsl_1_120_BASELINE.tsv" using ($1):($2*100) title 'Baseline' w lp ls 1, \
    "fsl_1_120_EDP.tsv" using ($1):($2*100) title 'EDP' w lp ls 2, \
    "fsl_1_120_CEDP.tsv" using ($1):($2*100) title 'CEDP' w lp ls 3
