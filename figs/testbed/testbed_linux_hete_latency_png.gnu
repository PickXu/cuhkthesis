...
set output "testbed_linux_hete_latency.png"
set size 0.9,0.9
...
set ylabel 'Read latency(sec)' offset 4.1
...
set logscale y
set key top left box lw 2 reverse Left font ',45' width '2' samplen 4 spacing 1
...
set style line 3 lt 3 lw 10 pt 11 ps 0 lc rgb "green"
set style line 4 lt 4 lw 10 pt 13 ps 0 lc rgb "blue"
set style line 5 lt 5 lw 10 pt 15 ps 0 lc rgb "blue"
set style line 6 lt 6 lw 10 pt 17 ps 0 lc rgb "orange"
set style line 7 lt 7 lw 10 pt 19 ps 0 lc rgb "purple"
set style line 8 lt 8 lw 10 pt 21 ps 0 lc rgb "brown"
set style line 9 lt 9 lw 10 pt 23 ps 0 lc rgb "pink"
